...
public class FragmentSetupIMU extends SetupMainPanel implements OnDroneListener {
	...
	private void startCalibration() {
		if (parentActivity.drone != null) {
			parentActivity.drone.calibrationSetup.startCalibration(5);
		}
	}
	...
	private void processOrientation(String message) {
		if (message.contains("directions left: x+ x- y+ y- z+ z- "))
			calibration_step = 1;
		else if (message.contains("directions left: x+ x- y+ y- z+ "))
			calibration_step = 2;
		else if (message.contains("directions left: x+ x- y- z+ "))
			calibration_step = 3;
		else if (message.contains("directions left: x+ x- z+ "))
			calibration_step = 4;
		else if (message.contains("directions left: x- z+ "))
			calibration_step = 5;
		else if (message.contains("directions left: z+ "))
			calibration_step = 6;
		/*else if (message.contains("accel calibration: starte"))
			calibration_step = 7;*/
