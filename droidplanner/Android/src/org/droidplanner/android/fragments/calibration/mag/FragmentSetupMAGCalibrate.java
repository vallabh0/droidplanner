...
public class FragmentSetupMAGCalibrate extends SetupSidePanel {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		final View view = inflater.inflate(R.layout.fragment_setup_mag_calibrate,
				container, false);

        final SetupSensorFragment setupFragment = (SetupSensorFragment) getParentFragment();

        textDesc = (TextView) view.findViewById(R.id.textViewDescM);
        btnStep = (Button) view.findViewById(R.id.buttonMag);
