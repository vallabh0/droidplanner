...
public class FragmentSetupGYROCalibrate extends SetupSidePanel {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		final View view = inflater.inflate(R.layout.fragment_setup_gyro_calibrate,
				container, false);

        final SetupSensorFragment setupFragment = (SetupSensorFragment) getParentFragment();

        textDesc = (TextView) view.findViewById(R.id.textViewDescG);
        btnStep = (Button) view.findViewById(R.id.buttonGyro);
